                                    ...
                                    (
                                        <tr key={bets._id} className="flex-table row" role="rowgroup">
                                            ...
                                            <td className="flex-row" role="cell">
                                                <Link className="btn--edit" to={`/edit/${bets._id}`}
                                                      onClick={() => this.props.handleEdit(bets._id)}>Edit</Link>

                                                <Link className="btn--delete" to={`/delete/${bets._id}`}
                                                      onClick={() => this.props.handleEdit(bets._id)}>Delete</Link>
                                            </td>
                                        </tr>
                                    )
                                    :
